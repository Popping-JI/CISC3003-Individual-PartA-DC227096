...
<head>
  ...
  <title>DC227096 JI GUANGNING: Cart</title>
...
<body>
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="itemTotal"><i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['total_price'],2); ?></td>
                <td>
  ...
  $(document).ready(function() {
    ...
    $(".itemQty").on('change', function() {
      ...
      // 计算新的总价
      var totalPrice = (pprice * qty).toFixed(2);
      ...
      $.ajax({
        ...
        success: function(response) {
          // 更新当前行的总价
          $el.find(".itemTotal").html('<i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;' + totalPrice);
    ...
    function calculateGrandTotal() {
      ...
      $("td[colspan='2'] + td b").html('<i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;' + grandTotal.toFixed(2));
    }
